...
void JLMessage::setSerializedMessage(uint8_t * msg, uint8_t len)
{
  ...
  memcpy(this->data, msg + JL_MESSAGE_HEADERS_LEN, this->len);

}

void JLMessage::getSerializedMessage(uint8_t * msg, uint8_t * len)
{
  ...
  // Append the Data
  memcpy(msg + JL_MESSAGE_HEADERS_LEN, this->data, this->len);

  // Return the Total Length
  *len = JL_MESSAGE_HEADERS_LEN + this->len;

}

void JLMessage::printMessage()
{
